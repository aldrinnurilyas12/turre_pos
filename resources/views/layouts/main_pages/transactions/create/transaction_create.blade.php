          ...
          <div class="container">
                          ...
                          <div class="products-card">
                            @if($all_products->isNotEmpty())
                              ...
                              <div class="card">
                                  ...
                                  <img class="card-img" src="{{asset('storage/' . $products->images)}}" alt="">
                                  <p style="margin-bottom: 10px;"><strong>{{$products->product_name}}</strong></p>
                                  ...
                                  <div class="btn-add-cart">
                                      <form action="{{ route('cart_add') }}" method="POST">
                                          @csrf
                                          <button class="btn-add-to-cart" type="submit">Tambah</button>
                                          <input type="text" name="id" value="{{$products->id}}" hidden>
                                            <input type="text" name="images" value="{{$products->images}}" hidden>
                                          <input type="text" name="product_name" value="{{$products->product_name}}" hidden>
                                          <input type="text" name="price" value="{{$products->price}}" hidden>
                                          <input type="hidden" value="1"> <!-- Default quantity -->
                                      </form>
                                  </div>
                ...
                <div class="transaction-card">
                  ...
                  <form action="{{route('transaction.store')}}" method="POST">
                            ...
                            <div class="cart-item">
                              <div class="container-content-product">
                                ...
                                <div class="image-content">
                                  <img width="50" height="50" src="{{asset('storage/' . $cart['images'])}}" alt="Product Image">
                                </div>
                                ...
                                <div class="sub-container-product">
                                  ...
                                  <div class="flex-content" style="display: flex; justify-content: space-between;">
                                    <p class="item-price">{{"Rp.".number_format($cart['price'])}}</p>
                                  </div>
                                </div>
                              ...
                              <div class="btn-delete-product">
                                ...
                                <div class="quantity-container">
                                  ...
                                  <input id="qtyProduct" name="quantity_per_product" type="number" class="item-quantity">
                        ...
                        <div class="open-pay-method">
                          <select class="form-control" name="payment_method" id="">
                            ...
                            @foreach($discount as $disc)
                              <option  value="{{$disc->discount_code}}">{{$disc->discount_name}}</option>
                            @endforeach
                          </select> 
                        </div>
                      ...
                      <div class="promo-code">
                          <input class="form-control" name="promo_code" type="text" placeholder="Masukan kode promo">
                      ...
                      <div class="customer-segment">
                        <div class="customer-input">
                          ...
                          <input class="form-control" type="text" name="customer" id="" autocomplete="off">
                        </div>
                        <br>
                        <div class="customer-input">
                      ...
                      <div class="payment-amount">
                        <div style="margin-bottom: 10px;" class="amount">
                          ...
                          <input name="amount" id="amount" class="form-control" type="text" autocomplete="off">
                        </div>
                        
                        <div class="payment-changes">
                          <label for=""><strong>Kembalian</strong></label>
                          <input id="paychange" name="payment_changes" class="form-control" type="text" readonly>
                        </div>
                      </div>
                      ...
                      <div class="totals">
                        ...
                        <hr>
                          ...
                          <div class="content-total">
                              ...
                              <input id="grandtotal" type="text" value="{{$grand_total}}" name="total">
                          </div>
                      </div>
            ...
            <div class="filter-content">
              ...
              <div class="category-scroll">
                <ul style="gap:20px;" id="nav-scroll" class="nav nav-tabs" role="tablist">
                 <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="tab-all" data-bs-toggle="tab" href="#tab-all" role="tab" aria-controls="tab-all" aria-selected="true">Semua</a>
                  </li>
                  @foreach($category_data as $ctg)
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="simple-tab" data-bs-toggle="tab" href="#simple-tabpanel-0" role="tab" aria-controls="simple-tabpanel-0" aria-selected="true">{{$ctg->category_name}}</a>
                  </li>
                  @endforeach
                </ul>
              </div>
            ...
            <div class="main-container-content">
              <div class="container-content">
                <div class="tab-content" id="tab-content">
                  <div class="tab-pane active" id="tab-all" role="tabpanel" aria-labelledby="tab-all">
                  <div class="card-body">
                    <div class="content-product-show">
                        <div class="products-card">
                          @if($all_products->isNotEmpty())
              ...
              <div class="open-dialog-clear-cart">
                ...
                <form action="{{route('transaction.store')}}" method="POST">
                        ...
                        @foreach($cart_value as $cart)
                          <div class="cart-item">
                            ...
                            <div class="btn-delete-product">
                              ...
                              <div class="quantity-container">
                                <button type="button" class="decrease">-</button>
                                <input name="quantity_per_product" type="number" class="item-quantity">
                                <button type="button" class="increase">+</button>
                              </div>
                            </div>
                    ...
                    <div class="customer-segment">
                      ...
                      <div class="customer-input">
                        <label for=""><strong>Email Pelanggan (opsional)</strong></label>
                        <input class="form-control" type="email" name="email" id="" autocomplete="off">
                      </div>
                      <hr>
                    </div>
                    ...
                    <div class="totals">
                        <div class="content-total">
                            <span class="title-total">Total barang : </span>
                            <span id="total-quantity">0</span>
                            <input value="0" type="text" name="quantity" id="total-quantity-result" hidden>
                       ...
                       <hr>
                        <div class="content-total">
                            ...
                            <input value="0" type="text" name="total" id="total-input" hidden>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="checkout-button">Checkout</button>
                    @else
                    <button style="width: 100%;" type="button" class="btn btn-secondary">Checkout</button>
                    @endif
                </form>
              </div>
...
document.querySelectorAll('.item-price').forEach((priceElement, index) => {
  pricePerItems[index] = parseFloat(priceElement.textContent.replace(/\D/g, '')) || 0; // Ambil harga per produk dari elemen
});
...
function updateTotal(index) {
  if (subtotalSpans[index]) {
    ...
    subtotalSpans[index].textContent = "Rp. " + subtotal.toLocaleString(); // Perbarui subtotal untuk produk yang sesuai
...
decreaseButtons.forEach((button, index) => {
  button.addEventListener('click', () => {
    if (parseInt(quantityInputs[index].value) > 1) { // Pastikan quantity tidak kurang dari 1
      quantityInputs[index].value = parseInt(quantityInputs[index].value) - 1; // Kurangi quantity
      updateTotal(index); // Update subtotal dan grand total
    }
  });
});
