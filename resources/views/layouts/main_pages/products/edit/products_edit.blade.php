            ...
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    @foreach ($products as $product)
                        <form action="{{ route('edit_product', $product->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly
                                    value="{{ app('App\Http\Controllers\Auth\AuthenticatedSessionController')->getUsers()->shop_name }}">
                            </div>
                            <hr>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" id="">
                                    ...
                                    @foreach ($product_category as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->category_name == $product->category_name ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" inputmode="numeric" name="stock" class="form-control"
                                    value="{{ $product->stock }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" inputmode="numeric" name="product_size" class="form-control"
                            ...
                            @if ($product->images)
                                <img width="100" height="100" src="{{ asset('storage/' . $product->images) }}"
                                    alt="">
                                <br>
                                <br>
                                <div class="form-group">
